...
class NDB:
    ...
    def construct_bins(self, training_samples, bins_file):
        ...
        print('used_d_indices: ',len(self.used_d_indices))
        print('samples: ',whitened_samples[:,self.used_d_indices].shape)
        ...
        for i in range(k):
            ...
            a = whitened_samples[clusters.labels_ == i, :]
            print('cluster ',i,' num: ',a.shape)
