...
output_check = "../../data/Denoising/check"
saved_models_dir = "../../data/Denoising/saved_model"
logs_dir = "../../data/Denoising/logs"

""" testing """
real_dataset_save = "../../data/Denoising/test_output/real_dataset"